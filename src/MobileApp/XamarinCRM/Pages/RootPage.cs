...
namespace XamarinCRM.Pages
{
    ...
    public class RootPage : MasterDetailPage
    {
        ...
        public RootPage()
        {
            ...
            //setup home page
            //  NaviguType.SalateAsync(Menes);
            NavigateAsync(MenuType.Default);
        }
            ...
            if (!Pages.ContainsKey(id))
            {
                switch (id)
                {
                    case MenuType.Default:
                        var page = new CRMNavigationPage(new Default
                        {
                            Title = TextResources.MainTabs_Default,
                    ...
                    case MenuType.Sales:
                         page = new CRMNavigationPage(new SalesDashboardPage
                            { 
    ...
    public class RootTabPage : TabbedPage
    {
        public RootTabPage()
        {
            Children.Add(new CRMNavigationPage(new Default
            {
                Title = TextResources.MainTabs_Default,
                Icon = new FileImageSource { File = "sales.png" }
            })
