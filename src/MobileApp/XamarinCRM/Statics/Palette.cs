...
namespace XamarinCRM.Statics
{
    public static class Palette
    {
        ...
        public static readonly Color _001 = Color.FromHex("#3399FF");

        /// <summary>
        /// Secondary color. Device status bar on Android.
        /// </summary>
        public static readonly Color _002 = Color.FromHex("#333399");

        /// <summary>
        /// Ternary color. Accent color on Android.
        /// </summary>
        public static readonly Color _003 = Color.FromHex("#3366CC");
        ...
        /// </summary>
        public static readonly Color _017 = Color.FromHex("#8C489F");
